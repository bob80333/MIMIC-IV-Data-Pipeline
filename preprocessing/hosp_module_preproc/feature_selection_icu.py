...
def feature_icu(cohort_output, version_path, diag_flag=True,out_flag=True,chart_flag=True,proc_flag=True,med_flag=True):
    if diag_flag:
        ...
        diag = preproc_icd_module("/data/corpora_alpha/MIMIC/MIMIC_IV_2.2/files/"+version_path+"/hosp/diagnoses_icd.csv.gz", './data/cohort/'+cohort_output+'.csv.gz', './utils/mappings/ICD9_to_ICD10_mapping.txt', map_code_colname='diagnosis_code')
    ...
    if out_flag:  
        ...
        out = preproc_out("/data/corpora_alpha/MIMIC/MIMIC_IV_2.2/files/"+version_path+"/icu/outputevents.csv.gz", './data/cohort/'+cohort_output+'.csv.gz', 'charttime', dtypes=None, usecols=None)
    ...
    if chart_flag:
        ...
        chart=preproc_chart("/data/corpora_alpha/MIMIC/MIMIC_IV_2.2/files/"+version_path+"/icu/chartevents.csv.gz", './data/cohort/'+cohort_output+'.csv.gz', 'charttime', dtypes=None, usecols=['stay_id','charttime','itemid','valuenum','valueuom'])
        #COMMENTED BY ROHAN
    ...
    if proc_flag:
        ...
        proc = preproc_proc("/data/corpora_alpha/MIMIC/MIMIC_IV_2.2/files/"+version_path+"/icu/procedureevents.csv.gz", './data/cohort/'+cohort_output+'.csv.gz', 'starttime', dtypes=None, usecols=['stay_id','starttime','itemid'])
    ...
    if med_flag:
        ...
        med = preproc_meds("/data/corpora_alpha/MIMIC/MIMIC_IV_2.2/files/"+version_path+"/icu/inputevents.csv.gz", './data/cohort/'+cohort_output+'.csv.gz')
